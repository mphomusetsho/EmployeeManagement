...
public static class GravatarHtmlHelper
{
    ...
    /// built in options which you can also use as defaults. 
    /// Most of these work by taking the requested email hash and using it to generate a
    /// themed image that is unique to that email address
    /// </summary>
